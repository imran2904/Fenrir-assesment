  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex items-center justify-end gap-2 md:gap-3">
        ...
        <button className="px-3 md:px-4 py-2 bg-red-500 text-white rounded-lg text-xs md:text-sm font-medium hover:bg-red-600 transition-colors">
          Stop Scan
        </button>
      </div>
      ...
      <div className="bg-white dark:bg-[#1A1A1A] rounded-xl border border-gray-200 dark:border-[#2A2A2A] overflow-hidden">
        <div className="p-4 md:p-6 lg:p-8">
          <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8 lg:gap-16">
            <div className="flex-shrink-0 mx-auto md:mx-0 md:pt-4">
              <div className="relative w-24 h-24 md:w-28 md:h-28 bg-[#1A1D29] rounded-full flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeWidth="3"
                    fill="none"
                    strokeDasharray={`${activeScanData.progress * 2.64} 264`}
                    className="text-[#0CC8A8] transition-all duration-500"
                  />
                </svg>
      ...
      <div className="bg-white dark:bg-[#1A1A1A] rounded-lg border border-gray-200 dark:border-[#2A2A2A] overflow-hidden">
        ...
        <div 
          className={`transition-all duration-300 ease-in-out overflow-hidden ${
            consoleExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'
          }`}
        >
              ...
              <div className="border-b border-gray-200 dark:border-[#2A2A2A]">
                <div className="flex gap-4 md:gap-6 px-3 md:px-4 overflow-x-auto">
                  <button
                    ...
                    className={`py-2 md:py-3 text-xs md:text-sm font-medium border-b-2 transition-colors whitespace-nowrap ${
                      activeTab === "activity"
